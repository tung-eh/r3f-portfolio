...
const Mobile = (props) => {
  /* Iphone model downloaded from https://market.pmnd.rs/model/iphone-x */
  ...
  return (
    <group
      ...
      scale={0.5}
    >
      <Html transform distanceFactor={1.595} position={[0.165, 1.255, 0.1]}>
        <iframe
      ...
      <group position={[0, 1.56, 0]}>
        ...
        <mesh geometry={nodes.SCREEN.geometry}>
          <meshStandardMaterial color="rgb(245, 245, 245)" />
        </mesh>
        <mesh
